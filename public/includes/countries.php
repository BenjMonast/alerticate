...
*
*/
function countrySelector($defaultCountry = "", $id = "", $name = "", $classes = "", $atts = ""){
    $countryArray = $GLOBALS['countryArray'];
    
    $output = "<b>+ </b><select id='".$id."' name='".$name."' class='".$classes."' " . $atts . ">";
	
	foreach($countryArray as $code => $country){
		$countryName = ucwords(strtolower($country["name"])); // Making it look good
		$output .= "<option data-code=" . $code . " value='" . $country['code'] . "' " . (($country['code']==$defaultCountry)?"selected ":"")  . ">" . $country['code']  . "</option>";
	}
